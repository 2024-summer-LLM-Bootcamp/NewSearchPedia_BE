...
# Enter an article or summary of the article here.
news_text = """

"""

news_document = Document(
...
chain_output = rag_chain.invoke({"input": news_text})
...
keywords = [keyword.split(' ', 1)[1].strip().strip('"')
            for keyword in keywords_with_numbers if keyword.strip()]
